// Command ChurchCalendar-mcp is an MCP server exposing the ChurchCalendar
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ChurchCalendar_list  — list records of an entity
//	ChurchCalendar_load  — load a single record of an entity
//
