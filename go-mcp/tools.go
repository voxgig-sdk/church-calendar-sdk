...
type Args struct {
	Entity string         `json:"entity" jsonschema:"calendar"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ChurchCalendarSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "church-calendar_list",
		Description: "List records from ChurchCalendar. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "church-calendar_load",
		Description: "Load a single record from ChurchCalendar. " +
...
func runOp(client *sdk.ChurchCalendarSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ChurchCalendarSDK, name string) (sdk.ChurchCalendarEntity, error) {
