...
// ChurchCalendar SDK utility: fetcher

class ChurchCalendarFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ChurchCalendarSDK/1.0)';
    ...
    public static function call(ChurchCalendarContext $ctx, string $fullurl, array $fetchdef): array
    {
