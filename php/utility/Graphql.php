...
// ChurchCalendar SDK utility: graphql
//
...
class ChurchCalendarGraphql
{
    ...
    // equivalent.
    public static function body(ChurchCalendarContext $ctx): mixed
    {
    ...
    public static function errors(ChurchCalendarContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
