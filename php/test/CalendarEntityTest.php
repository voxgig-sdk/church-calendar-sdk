...
class CalendarEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = ChurchCalendarSDK::test($seed, null);
        $seen = iterator_to_array($base->Calendar(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Calendar(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CHURCH_CALENDAR_TEST_CALENDAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function calendar_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CHURCH_CALENDAR_TEST_CALENDAR_ENTID");
