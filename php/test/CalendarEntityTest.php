...
class CalendarEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set CHURCHCALENDAR_TEST_CALENDAR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function calendar_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("CHURCHCALENDAR_TEST_CALENDAR_ENTID");
