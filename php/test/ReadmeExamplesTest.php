...
// ChurchCalendar SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ChurchCalendarSDK::test)
...
{
    private const SDK_CLASS = 'ChurchCalendarSDK';
    ...
    private const SDK_BASE = 'churchcalendar_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../churchcalendar_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
