...
// ChurchCalendar SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ChurchCalendarOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ChurchCalendarOmni::structfix($now, Struct::undef()))
                        !== json_encode(ChurchCalendarOmni::structfix($val, Struct::undef()))) {
