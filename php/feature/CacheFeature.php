...
// ChurchCalendar SDK cache feature
...
class ChurchCalendarCacheFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _through(ChurchCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
