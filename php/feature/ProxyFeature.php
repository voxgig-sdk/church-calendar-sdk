...
// ChurchCalendar SDK proxy feature
...
class ChurchCalendarProxyFeature extends ChurchCalendarBaseFeature
{
    ...
    public function init(ChurchCalendarContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ChurchCalendarContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
