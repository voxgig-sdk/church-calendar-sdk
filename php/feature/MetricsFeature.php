...
// ChurchCalendar SDK metrics feature
...
class ChurchCalendarMetricsFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _record(ChurchCalendarContext $ctx, bool $ok): void
    {
