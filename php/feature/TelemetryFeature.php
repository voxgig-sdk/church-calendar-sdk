...
// ChurchCalendar SDK telemetry feature
...
class ChurchCalendarTelemetryFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _close(ChurchCalendarContext $ctx, bool $ok): void
    {
