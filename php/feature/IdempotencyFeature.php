...
// ChurchCalendar SDK idempotency feature
...
class ChurchCalendarIdempotencyFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _mutating(ChurchCalendarContext $ctx): bool
    {
