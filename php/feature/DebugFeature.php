...
// ChurchCalendar SDK debug feature
...
class ChurchCalendarDebugFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _finish(ChurchCalendarContext $ctx, bool $ok): void
    {
