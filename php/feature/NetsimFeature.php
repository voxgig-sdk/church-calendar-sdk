...
// ChurchCalendar SDK netsim feature
...
class ChurchCalendarNetsimFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _simulate(ChurchCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ChurchCalendarContext $ctx, array $applied): void
    {
        $client = $this->client;
