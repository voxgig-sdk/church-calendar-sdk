...
// ChurchCalendar SDK ratelimit feature
...
class ChurchCalendarRatelimitFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _acquire(ChurchCalendarContext $ctx): void
    {
    ...
    private function _track(ChurchCalendarContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
