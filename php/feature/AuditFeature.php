...
// ChurchCalendar SDK audit feature
...
class ChurchCalendarAuditFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _emit(ChurchCalendarContext $ctx, string $outcome): void
    {
