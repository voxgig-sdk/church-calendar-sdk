...
// ChurchCalendar SDK streaming feature
...
class ChurchCalendarStreamingFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _iterate(ChurchCalendarResult $result): \Generator
    {
    ...
    private function _streamable(ChurchCalendarContext $ctx): bool
    {
