...
func NewCalendarEntity(client *core.ChurchCalendarSDK, entopts map[string]any) *CalendarEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CalendarEntity) GetName() string { return e.name }
...
func (e *CalendarEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CalendarEntity) Deleted() bool {
	return e.deleted
}


func (e *CalendarEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCalendarEntity(e.client, opts)
}

func (e *CalendarEntity) Data(args ...any) any {
...
func (e *CalendarEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Calendar; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CalendarEntity) DataTyped(data ...Calendar) Calendar {
	if len(data) > 0 {
		return typedFrom[Calendar](e.Data(asMap(data[0])))
	}
	return typedFrom[Calendar](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Calendar (all fields
// optional at the wire level).
func (e *CalendarEntity) MatchTyped(match ...Calendar) Calendar {
	if len(match) > 0 {
		return typedFrom[Calendar](e.Match(asMap(match[0])))
	}
	return typedFrom[Calendar](e.Match())
}
...
func (e *CalendarEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CalendarEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CalendarLoadMatch and returns an Calendar. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CalendarEntity) LoadTyped(reqmatch CalendarLoadMatch, ctrl map[string]any) (Calendar, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Calendar{}, err
	}
	return typedFrom[Calendar](res), nil
}




func (e *CalendarEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CalendarListMatch and returns []Calendar. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CalendarEntity) ListTyped(reqmatch CalendarListMatch, ctrl map[string]any) ([]Calendar, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Calendar](res), nil
}



func (e *CalendarEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CalendarEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CalendarEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CalendarEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
