...
func (sdk *ChurchCalendarSDK) OptionsMap() map[string]any {
...
func (sdk *ChurchCalendarSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ChurchCalendarSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ChurchCalendarSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ChurchCalendarSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ChurchCalendarSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ChurchCalendarSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ChurchCalendarSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ChurchCalendarSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ChurchCalendarSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ChurchCalendarSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ChurchCalendarSDK {
	...
	sdk := NewChurchCalendarSDK(sdkopts)
	sdk.Mode = "test"
