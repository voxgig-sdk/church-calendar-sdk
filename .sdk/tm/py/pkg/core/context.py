...
from projectname_sdk.core.control import ChurchCalendarControl
...
class ChurchCalendarContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ChurchCalendarControl()
        ...
        if isinstance(sp, ChurchCalendarSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ChurchCalendarResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ChurchCalendarResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ChurchCalendarOperation({})
    ...
    def make_error(self, code, msg):
        return ChurchCalendarError(code, msg, self)
