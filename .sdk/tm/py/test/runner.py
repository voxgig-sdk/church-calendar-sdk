...
class ChurchCalendarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChurchCalendarTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ChurchCalendarTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ChurchCalendarTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
