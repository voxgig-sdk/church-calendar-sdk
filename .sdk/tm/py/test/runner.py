...
class ChurchCalendarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChurchCalendarTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ChurchCalendarTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ChurchCalendarTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
