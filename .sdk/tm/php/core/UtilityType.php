...
// ChurchCalendar SDK utility type

class ChurchCalendarUtility
{
    ...
    public static function copy(ChurchCalendarUtility $src): ChurchCalendarUtility
    {
        $u = new ChurchCalendarUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
