...
// ChurchCalendar SDK utility: make_options

class ChurchCalendarMakeOptions
{
    ...
    public static function call(ChurchCalendarContext $ctx): array
    {
        ...
        //
        // `ChurchCalendarSchema::optspec()` is built from the model:
        ...
        $optspec = ChurchCalendarSchema::optspec();
