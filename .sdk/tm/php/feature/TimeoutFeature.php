...
// ChurchCalendar SDK timeout feature
...
class ChurchCalendarTimeoutFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _with_timeout(ChurchCalendarContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ChurchCalendarContext $_ctx, float $ms): void
    {
        $client = $this->client;
