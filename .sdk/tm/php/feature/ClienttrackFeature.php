...
// ChurchCalendar SDK clienttrack feature
...
class ChurchCalendarClienttrackFeature extends ChurchCalendarBaseFeature
{
    ...
    public function PostConstruct(ChurchCalendarContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ChurchCalendar-SDK';
