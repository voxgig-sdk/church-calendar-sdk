...
// ChurchCalendar SDK rbac feature
...
class ChurchCalendarRbacFeature extends ChurchCalendarBaseFeature
{
    ...
    private function _required(ChurchCalendarContext $ctx): ?string
    {
    ...
    private function _reject(ChurchCalendarContext $ctx, string $required): void
    {
    ...
    private function _track(ChurchCalendarContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
