...
|---|---|---|
| `ts/` | @voxgig-sdk/church-calendar-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/church-calendar-sdk \
      --repository voxgig-sdk/church-calendar-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/church-calendar-sdk` shows it, and
`npm trust revoke @voxgig-sdk/church-calendar-sdk --id=<id>` removes it.
