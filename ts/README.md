# ChurchCalendar TypeScript SDK

The TypeScript SDK for the ChurchCalendar API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `ChurchCalendarSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ChurchCalendarSDK.test(testopts?, sdkopts?)` | `ChurchCalendarSDK` | Create a test-mode client. |
...
| `client` | `client(): ChurchCalendarSDK` | Return the parent SDK client. |
...
church-calendar/
├── src/
│   ├── ChurchCalendarSDK.ts        # Main SDK class
