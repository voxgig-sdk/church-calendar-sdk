...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CHURCHCALENDAR_TEST_LIVE ||
    'TRUE' === process.env.CHURCHCALENDAR_TEST_OVERRIDE
  ) {
  ...
  m.CHURCHCALENDAR_TEST_EXPLAIN = process.env.CHURCHCALENDAR_TEST_EXPLAIN || m.CHURCHCALENDAR_TEST_EXPLAIN
