...
function envOverride(m) {
    if ('TRUE' === process.env.CHURCH_CALENDAR_TEST_LIVE ||
        'TRUE' === process.env.CHURCH_CALENDAR_TEST_OVERRIDE) {
    ...
    m.CHURCH_CALENDAR_TEST_EXPLAIN = process.env.CHURCH_CALENDAR_TEST_EXPLAIN || m.CHURCH_CALENDAR_TEST_EXPLAIN;
    return m;
}
