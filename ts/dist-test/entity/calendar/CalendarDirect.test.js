...
(0, node_test_1.describe)('CalendarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ChurchCalendarSDK({
    ...
    (0, node_test_1.test)('direct-load-calendar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-calendar', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-calendar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-calendar', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["locale01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.CHURCH_CALENDAR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ChurchCalendarSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CHURCH_CALENDAR_TEST_CALENDAR_ENTID'];
    ...
    const client = new __1.ChurchCalendarSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CalendarDirect.test.js.map