...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/church-calendar-sdk/releases)),
...
local result, err = client:Calendar():list()
...
```
lua/
├── church-calendar_sdk.lua    -- Main SDK module
...
The main module (`church-calendar_sdk`) exports the SDK constructor
...
-- calendar:data_get() now returns the calendar data from the last list
