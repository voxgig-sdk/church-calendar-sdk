...
function runner.env_override(m)
  local live = runner.getenv("CHURCHCALENDAR_TEST_LIVE")
  local override = runner.getenv("CHURCHCALENDAR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHURCHCALENDAR_TEST_EXPLAIN")
