...
function runner.env_override(m)
  local live = runner.getenv("CHURCH_CALENDAR_TEST_LIVE")
  local override = runner.getenv("CHURCH_CALENDAR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CHURCH_CALENDAR_TEST_EXPLAIN")
