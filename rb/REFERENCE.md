# ChurchCalendar Ruby SDK Reference

Complete API reference for the ChurchCalendar Ruby SDK.
...
#### `ChurchCalendarSDK.test(testopts = nil, sdkopts = nil)`
...
| `season_week` | `Integer` | No | Week number within the liturgical season |
