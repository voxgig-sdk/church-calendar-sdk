...
class CalendarEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CHURCHCALENDAR_TEST_CALENDAR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def calendar_basic_setup(extra)
  ...
  entid_env_raw = ENV["CHURCHCALENDAR_TEST_CALENDAR_ENTID"]
