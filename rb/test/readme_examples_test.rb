...
#      offline in seeded test mode (ChurchCalendarSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ChurchCalendar_sdk.rb")
  SDK_CLASS = "ChurchCalendarSDK"
