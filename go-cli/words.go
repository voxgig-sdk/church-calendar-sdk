...
func registerSDKWords(r *eng.Registry, client *sdk.ChurchCalendarSDK) {
...
func runOp(client *sdk.ChurchCalendarSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
