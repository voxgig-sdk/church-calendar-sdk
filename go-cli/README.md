...
AQL-driven CLI and REPL for the ChurchCalendar SDK. Positional arguments are
...
```sh
go build -o church-calendar-cli ./...
```
...
./church-calendar-cli load 1 calendar
./church-calendar-cli load '{id:1}' calendar
