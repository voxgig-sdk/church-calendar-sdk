...
from churchcalendar_sdk.utility import register

# Load features
from churchcalendar_sdk.feature.base_feature import ChurchCalendarBaseFeature
from churchcalendar_sdk.features import _has_feature, _make_feature
...
class ChurchCalendarSDK:
    ...
    def get_utility(self):
        return ChurchCalendarUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ChurchCalendarSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Calendar(self, data=None) -> "CalendarEntity":
        ...
        from churchcalendar_sdk.entity.calendar_entity import CalendarEntity
