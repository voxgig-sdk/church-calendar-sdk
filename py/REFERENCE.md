# ChurchCalendar Python SDK Reference

Complete API reference for the ChurchCalendar Python SDK.
...
#### `ChurchCalendarSDK.test(testopts=None, sdkopts=None)`
...
```python
results, err = client.Calendar().list({})
```
