...
class ChurchCalendarTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ChurchCalendarTestRunner.getenv("CHURCHCALENDAR_TEST_LIVE")
        override = ChurchCalendarTestRunner.getenv("CHURCHCALENDAR_TEST_OVERRIDE")
        ...
        explain = ChurchCalendarTestRunner.getenv("CHURCHCALENDAR_TEST_EXPLAIN")
