# ChurchCalendar SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ChurchCalendarSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ChurchCalendarSDK(...) and ChurchCalendarSDK.test(...) become
#      ChurchCalendarSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "churchcalendar_sdk"
_SDK_CLASS = "ChurchCalendarSDK"
